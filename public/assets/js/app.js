...
(function () {
    ...
    function twoColumnMenuGenerate() {
        ...
        if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
            ...
            var currentPath = location.pathname == "/" ? "/ba/dashboard" : location.pathname.substring(1);
    ...
    function setDefaultAttribute() {
        if (!sessionStorage.getItem("defaultAttribute")) {
            ...
            var isLayoutAttributes = {};
            // isLayoutAttributes["data-layout"] = sessionStorage.getItem("data-layout") ?? 'vertical';
...
function scrollFunction() {
    if (!mybutton || !mybutton.hasOwnProperty('style')) {
        return
    }
