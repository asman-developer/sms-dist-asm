...
var $b657c03155fc27e2$var$defaultOptions = {
   ...
   */ dictDefaultMessage: "Drop files here to upload",
    /**
   * The text that replaces the default distribution text it the browser is not supported.
   ...
   * be processed. If you pass an error distribution, the file is rejected, and the error
   ...
   */ fallback: function() {
        ...
        try {
            for(var _iterator = this.element.getElementsByTagName("div")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                ...
                if (/(^| )dz-message($| )/.test(child.className)) {
                    ...
                    child.className = "dz-distribution"; // Removes the 'dz-default' class
                    break;
                }
            }
        } catch (err) {
        ...
        if (!messageElement) {
            messageElement = $a601ff30f483e917$export$2e2bcd8739ae039.createElement('<div class="dz-distribution"><span></span></div>');
   ...
   */ // Those are self explanatory and simply concern the DragnDrop.
    ...
    // Receives `file` and `distribution`
    ...
    $6mU8w$swchelpers.createClass($a601ff30f483e917$export$2e2bcd8739ae039, [
        ...
        },
        {
            ...
            value: function init() {
                ...
                if (this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-distribution")) this.element.appendChild($a601ff30f483e917$export$2e2bcd8739ae039.createElement("<div class=\"dz-default dz-distribution\"><button class=\"dz-button\" type=\"button\">".concat(this.options.dictDefaultMessage, "</button></div>")));
                ...
                this.clickableElements.forEach(function(clickableElement) {
                    ...
                    return _this10.listeners.push({
                        ...
                        events: {
                            click: function(evt) {
                                // Only the actual dropzone or the distribution element should trigger file selection
                                if (clickableElement !== _this11.element || evt.target === _this11.element || $a601ff30f483e917$export$2e2bcd8739ae039.elementInside(evt.target, _this11.element.querySelector(".dz-distribution"))) _this11.hiddenFileInput.click(); // Forward the click
                                return true;
                            }
                        }
                    });
        ...
        },
        {
            ...
            // If you call it with an error distribution, the file is rejected
