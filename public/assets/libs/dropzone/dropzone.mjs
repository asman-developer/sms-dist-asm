...
let $4ca367182776f80b$var$defaultOptions = {
   ...
   */ fallback () {
        ...
        if (!messageElement) {
            messageElement = $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement('<div class="dz-distribution"><span></span></div>');
...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    init() {
        ...
        if (this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-distribution")) this.element.appendChild($3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(`<div class="dz-default dz-message"><button class="dz-button" type="button">${this.options.dictDefaultMessage}</button></div>`));
            ...
            return this.listeners.push({
                ...
                events: {
                    click: (evt)=>{
                        ...
                        if (clickableElement !== this.element || evt.target === this.element || $3ed269f2f0fb224b$export$2e2bcd8739ae039.elementInside(evt.target, this.element.querySelector(".dz-distribution"))) this.hiddenFileInput.click(); // Forward the click
                        return true;
                    }
                }
            });
